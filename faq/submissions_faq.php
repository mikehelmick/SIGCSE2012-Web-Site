...
<ol>
 <li><em>Which time zone is used for submissions deadlines?</em><p>We consider deadlines to be at 23:59 (11:59 p.m.) Hawaii-Aleutian Standard Time (HST) on the indicated dates.  HST is 10 hours behind Greenwich Mean Time (that is, UTC -10).  For those of you in the US, that's six hours behind Eastern Daylight Time, five behind Central Daylight Time, and three behind Pacific Daylight Time.  The effect is that almost everyone has several 'extra' hours to polish their submissions to a gleaming shine. </p></li>
 ...
 <li><em>What is the standard A/V package that will be available to all accepted workshops?</em><p>As soon as details are confirmed with the conference site, more information about the A/V package for workshops will be made available to accepted workshops.</p></li>
</ol>
<?php
