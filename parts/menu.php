...
<div id="attendees_sub" class="submenu" style="<?php echo $menuStyle; ?>">
  <ul>
	...
	<li><a id="studentResearch_menu" href="/sigcse2012/attendees/student_research.php">Student Research Competition</a></li>
	<li><a id="attendeesEvaluation_menu" href="/sigcse2012/attendees/evaluations.php">Symposium Evaluations</a></li>
